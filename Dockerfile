...
RUN /bin/bash -c "source ~/.bashrc && pyenv virtualenv 3.12.1 django-main"
RUN echo 'pyenv activate django-main' >> ~/.bashrc
...
RUN /bin/bash -c "source ~/.bashrc && pyenv activate django-main && poetry install --no-root"
