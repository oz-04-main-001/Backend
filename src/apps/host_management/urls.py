...
from apps.host_management.views.host_booking_view import BookingCheckView, BookingRequestCheckView, \
    CompleteBookingsView, MyAccommodationsUpdateView, MyAccommodationsDeleteView, MyRoomsUpdateView, MyRoomsDeleteView, \
...
urlpatterns = [
    ...
    path('accommodation/list/', MyAccommodationListView.as_view(), name='host-management-my-accommodations-list',),
]
