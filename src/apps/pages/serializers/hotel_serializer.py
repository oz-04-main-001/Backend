...
from apps.accommodations.models import Accommodation, GPS_Info, Accommodation_Image
from apps.amenities.models import Amenity, AccommodationAmenity
...
class HotelDetailSerializer(serializers.ModelSerializer):
    ...
    def get_address(self, obj):
        ...
        address_full = f"{address_data['city']} {address_data['states']} {address_data['road_name']} {address_data['address']}"
        return address_full
