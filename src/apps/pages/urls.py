...
from . import views
from .views import main_view, hotel_view, room_view, booking_request_view, booking_status_view
...
urlpatterns = [
    ...
    path("bookings/request/<int:hotel_pk>/<int:pk>/", booking_request_view.BookingRequestView.as_view(), name="booking_request"),
